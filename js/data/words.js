...
const SETS = {
  "0": {
    ...
    "type": "chapter",
    "cards": [
      { "g": "Α α", "gName": "αλφα", "e": "a", "eName": "alpha", "alphabet": true, "required": true },
      { "g": "Β β", "gName": "βητα", "e": "b", "eName": "beta", "alphabet": true, "required": true },
      { "g": "Γ γ", "gName": "γαμμα", "e": "g", "eName": "gamma", "alphabet": true, "required": true },
      { "g": "Δ δ", "gName": "δελτα", "e": "d", "eName": "delta", "alphabet": true, "required": true },
      { "g": "Ε ε", "gName": "εψιλον", "e": "e", "eName": "epsilon (short e)", "alphabet": true, "required": true },
      { "g": "Ζ ζ", "gName": "ζητα", "e": "z", "eName": "zeta", "alphabet": true, "required": true },
      { "g": "Η η", "gName": "ητα", "e": "ē", "eName": "eta (long e)", "alphabet": true, "required": true },
      { "g": "Θ θ", "gName": "θητα", "e": "th", "eName": "theta", "alphabet": true, "required": true },
      { "g": "Ι ι", "gName": "ιωτα", "e": "i", "eName": "iota", "alphabet": true, "required": true },
      { "g": "Κ κ", "gName": "καππα", "e": "k", "eName": "kappa", "alphabet": true, "required": true },
      { "g": "Λ λ", "gName": "λαμβδα", "e": "l", "eName": "lambda", "alphabet": true, "required": true },
      { "g": "Μ μ", "gName": "μυ", "e": "m", "eName": "mu", "alphabet": true, "required": true },
      { "g": "Ν ν", "gName": "νυ", "e": "n", "eName": "nu", "alphabet": true, "required": true },
      { "g": "Ξ ξ", "gName": "ξι", "e": "x", "eName": "xi", "alphabet": true, "required": true },
      { "g": "Ο ο", "gName": "ομικρον", "e": "o", "eName": "omicron (short o)", "alphabet": true, "required": true },
      { "g": "Π π", "gName": "πι", "e": "p", "eName": "pi", "alphabet": true, "required": true },
      { "g": "Ρ ρ", "gName": "ρω", "e": "r", "eName": "rho", "alphabet": true, "required": true },
      { "g": "Σ σ / ς", "gName": "σιγμα", "e": "s", "eName": "sigma (ς is the final form)", "alphabet": true, "required": true },
      { "g": "Τ τ", "gName": "ταυ", "e": "t", "eName": "tau", "alphabet": true, "required": true },
      { "g": "Υ υ", "gName": "υψιλον", "e": "y", "eName": "upsilon (u / y)", "alphabet": true, "required": true },
      { "g": "Φ φ", "gName": "φι", "e": "ph", "eName": "phi", "alphabet": true, "required": true },
      { "g": "Χ χ", "gName": "χι", "e": "ch", "eName": "chi", "alphabet": true, "required": true },
      { "g": "Ψ ψ", "gName": "ψι", "e": "ps", "eName": "psi", "alphabet": true, "required": true },
      { "g": "Ω ω", "gName": "ωμεγα", "e": "ō", "eName": "omega (long o)", "alphabet": true, "required": true }
    ]
  },
  "1": {
