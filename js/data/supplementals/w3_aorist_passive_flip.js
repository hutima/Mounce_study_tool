...
//
// Mounce introduces the aorist passive in ch 24 (Part 3 — Indicative Verb).
// Many NT-common verbs have irregular θη-stems — ὁράω → ὤφθην uses an
// entirely different root, ἀποστέλλω → ἀπεστάλην drops σ and goes to η,
// λαμβάνω → ἐλήμφθην inserts a μ — and they need recall practice against
...
(function () {
  ...
  window.registerSupplementalVocabSet('W3_AORIST_PASSIVE_FLIP', {
    ...
    cards: [
      ...
      entry('σῴζω', 'I save', 'ἐσώθην', 'I was saved', 'ζ drops out entirely'),
